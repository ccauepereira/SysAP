    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          <Text style={styles.title}>Ativação de Conta</Text>
          <Text style={styles.description}>
            O fluxo de ativação de conta por convite, verificação de identidade e
            definição de senha estará disponível na Fase 3.
          </Text>
